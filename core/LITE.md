...
Karpathy-weight entry protocol for small projects, but compatible upward with Agent Wiki v3.
...
No cursors, no inboxes, no OpenCode audit. Those are added only when upgrading to MAX.
